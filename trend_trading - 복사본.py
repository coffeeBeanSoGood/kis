...
def create_config_file(config_path: str = "trend_trader_config.json") -> None:
    ...
    config = {
        "watch_list": [
            {"code": "005490", "name": "POSCO홀딩스", "allocation_ratio": 0.2},
            {"code": "373220", "name": "LG에너지솔루션", "allocation_ratio": 0.2},
            {"code": "000660", "name": "SK하이닉스", "allocation_ratio": 0.2},
            {"code": "035720", "name": "카카오", "allocation_ratio": 0.2},
            {"code": "005930", "name": "삼성전자", "allocation_ratio": 0.2}
        ],
        ...
        "trading_strategies": {
            ...
            "rsi_overbought_threshold": 70.0,  # RSI 과매수 기준
            "macd_fast_period": 12,  # MACD 빠른 이동평균
            "macd_slow_period": 26,  # MACD 느린 이동평균
            "macd_signal_period": 9  # MACD 시그널 라인
        }
    }
